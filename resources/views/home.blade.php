...
<body class="bg-gradient-to-r from-indigo-900 to-indigo-300 leading-normal tracking-normal text-white gradient"
    ...
    <div class="pt-10">
        <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            ...
            <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                ...
                @auth
                    <a href="#"
                        class="cursor-pointer mx-auto lg:mx-0 bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-110 duration-300 ease-in-out">
                        Mon tableau de bord
                    </a>
                @else
                    <a id="auth" href="{{ route('register') }}"
                        class="cursor-pointer mx-auto lg:mx-0 bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-110 duration-300 ease-in-out">
        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full sm:w-1/2 p-6">
                    <svg class="w-5/6 sm:h-64 mx-auto" version="1.1" viewBox="0 0 428.27 582.3"
                        xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
                        xmlns:dc="http://purl.org/dc/elements/1.1/"
                        xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                        <g transform="translate(-6.7288 .78942)">
                            <g transform="translate(-84.853 -276.78)">
                                <rect x="150" y="523.08" width="315" height="315" rx="10"
                                    ry="10" fill="#e1e1e1" />
                                <g transform="matrix(-1 0 0 -1 632.86 1396.2)">
                                    <rect x="178.57" y="746.29" width="56.429" height="28.929" rx="7.5276"
                                        ry="7.5276" fill="#d3d7cf" />
                                    <rect x="210.36" y="779.15" width="56.429" height="28.929" rx="7.5276"
                                        ry="7.5276" fill="#babdb6" />
                                    <rect x="240" y="734.15" width="56.429" height="28.929" rx="7.5276"
                                        ry="7.5276" fill="#c7c9c3" />
                                </g>
                                <rect x="178.57" y="746.29" width="56.429" height="28.929" rx="7.5276"
                                    ry="7.5276" fill="#d3d7cf" />
                                <rect x="210.36" y="779.15" width="56.429" height="28.929" rx="7.5276"
                                ...
                                <rect x="240" y="734.15" width="56.429" height="28.929" rx="7.5276"
                                    ry="7.5276" fill="#c7c9c3" />
                                <rect x="173.36" y="616.51" width="125.71" height="124.64" rx="8.3341"
                                    ry="8.5097" fill="#ac6f3c" />
                                <path transform="translate(84.853 276.78)"
                                    d="m221.58 101.64c-27.892 9.359-56.86 30.518-84.285 56.82v-15.707c0-4.1703-3.359-7.5273-7.5293-7.5273h-21.73c-4.1703 0-7.5273 3.3571-7.5273 7.5273v52.088c0 0.81585 0.13315 1.5994 0.37109 2.334-31.194 36.288-58.287 75.722-76.43 106.1 60.585 30.819 316.79 16.707 392.83 0-21.474-90.212-128.68-176.11-195.7-201.63z"
                                    fill="#ac6f3c" />
                                <path
                                    d="m187.17 622.79c-4.1703 0-7.5273 3.3571-7.5273 7.5273v39.25c0 4.1703 3.3571 7.5293 7.5273 7.5293h39.252c4.1703 0 7.5273-3.359 7.5273-7.5293v-39.25c0-4.1703-3.3571-7.5273-7.5273-7.5273h-39.252zm58.98 0c-4.1703 0-7.5273 3.3571-7.5273 7.5273v39.25c0 4.1703 3.3571 7.5293 7.5273 7.5293h39.25c4.1703 0 7.5273-3.359 7.5273-7.5293v-39.25c0-4.1703-3.3571-7.5273-7.5273-7.5273h-39.25zm-58.98 58.979c-4.1703 0-7.5273 3.359-7.5273 7.5293v39.25c0 4.1703 3.3571 7.5273 7.5273 7.5273h39.252c4.1703 0 7.5273-3.3571 7.5273-7.5273v-39.25c0-4.1703-3.3571-7.5293-7.5273-7.5293h-39.252zm58.98 0c-4.1703 0-7.5273 3.359-7.5273 7.5293v39.25c0 4.1703 3.3571 7.5273 7.5273 7.5273h39.25c4.1703 0 7.5273-3.3571 7.5273-7.5273v-39.25c0-4.1703-3.3571-7.5293-7.5273-7.5293h-39.25z"
                                    fill="#bbd4f0" />
                                <path
                                    d="m350.38 670.22h76.373c4.1703 0 7.5276 3.3573 7.5276 7.5276v160.27h-91.429v-160.27c0-4.1703 3.3573-7.5276 7.5276-7.5276z"
                                    fill="#ac6f3c" />
                                <rect x="353.21" y="756.65" width="15.714" height="7.8571" rx="7.5276"
                                    ry="7.5276" fill="#8f5902" />
                                <path
                                    d="m250 337.01c-68.417-26.06-43.682 51.269-40.324 67.213 0.74364-26.01 12.731-56.957 40.324-67.213z"
                                    fill="#babdb6" />
                                <path
                                    d="m157.94 298.43c68.417-18.917 31.896 21.269 40.681 79.356-17.172-25.295-13.088-69.1-40.681-79.356z"
                                    fill="#babdb6" />
                                <path
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <svg class="w-5/6 sm:h-64 mx-auto" version="1.1" viewBox="0 0 38.222 38.224"
                        ...
                        <defs>
                            <clipPath id="j">
                                <path
                                    d="m29.809 10.61c-1.305-4-3.825-6.961-7.559-8.883-3.734-1.918-7.602-2.238-11.602-0.961-4 1.309-6.957 3.829-8.878 7.563-1.918 3.734-2.239 7.598-0.961 11.598 1.308 4 3.828 6.96 7.562 8.882 3.731 1.918 7.613 2.239 11.637 0.957 4-1.304 6.949-3.824 8.844-7.558 1.918-3.731 2.238-7.598 0.957-11.598z" />
                            </clipPath>
                            <clipPath id="i">
                                <path d="m-3263.4-6355.7h54.098v54.098h-54.098v-54.098z" />
                            </clipPath>
                            <radialGradient id="c" cx="-3243.6" cy="-6329.9" r="25.902"
                            ...
                            <radialGradient id="b" cx="-3243.6" cy="-6329.9" r="25.902"
                                gradientUnits="userSpaceOnUse">
                            ...
                            <radialGradient id="a" cx="-3243.6" cy="-6329.9" r="25.902"
                                gradientUnits="userSpaceOnUse">
                            ...
                            <radialGradient id="d" cx="-3243.6" cy="-6329.9" r="25.902"
                                gradientUnits="userSpaceOnUse">
                        ...
                        <g transform="matrix(1.25 0 0 -1.25 0 38.224)">
                            <path
                                ...
                                fill="#ec4774" fill-rule="evenodd" />
                            <path
                                d="m24.41 3.087c-0.695-0.477-1.426-0.918-2.199-1.321-0.055-0.023-0.109-0.05-0.16-0.078-2.082-0.133-4.016 0.215-5.801 1.039-2.535 1.2-4.574 3.293-6.121 6.282-1.652 3.226-2.52 6.535-2.598 9.918-0.054 2.269 0.227 4.429 0.84 6.48 0.531 0.055 1.051 0.203 1.559 0.441 0.32 0.188 0.629 0.399 0.918 0.641 2.054-0.746 3.976-1.812 5.761-3.199 2.668-2.028 4.868-4.613 6.602-7.762 2.559-4.641 2.746-8.918 0.559-12.84 0.214 0.133 0.425 0.266 0.64 0.399z"
                                fill="#377afa" fill-rule="evenodd" />
                            <path
                                d="m11.09 29.927c-0.266-0.079-0.535-0.161-0.801-0.239 3.121 1.145 6.348 1.188 9.68 0.121 2.855-0.933 5.16-2.48 6.922-4.64-0.614 0.718-1.309 1.386-2.082 2-1.918 1.547-4.079 2.558-6.481 3.039-2.453 0.508-4.863 0.414-7.238-0.281zm-4.961-2.477c-1.68-1.254-3.051-2.801-4.121-4.641-1.227-2.214-1.879-4.574-1.957-7.082-0.028-1.117 0.051-2.211 0.238-3.277-0.508 2.449-0.348 4.957 0.481 7.52 1.093 3.359 3.066 5.984 5.921 7.878-0.187-0.132-0.375-0.265-0.562-0.398zm4.879-26.762c-0.133 0.028-0.266 0.067-0.399 0.121-0.398 0.133-0.785 0.278-1.16 0.438 0.348-0.133 0.707-0.266 1.082-0.399 0.16-0.054 0.317-0.105 0.477-0.16z"
                                fill="#4880eb" fill-rule="evenodd" />
                            <path
                                d="m10.848 26.489c-0.293-0.242-0.598-0.453-0.918-0.641-0.508-0.238-1.028-0.386-1.559-0.441-0.59-0.051-0.976 0.082-1.16 0.402l-0.043 0.36c0 0.32 0.187 0.664 0.562 1.039 0.321 0.32 0.68 0.586 1.079 0.801l0.882 0.32c0.344 0.504 0.813 1.039 1.399 1.598 2.375 0.695 4.785 0.789 7.238 0.281 2.402-0.481 4.563-1.492 6.481-3.039-4.266 2.293-8.735 2.613-13.399 0.961l0.121-0.121c0.211-0.426-0.015-0.934-0.683-1.52z"
                                fill="#fff" fill-rule="evenodd" />
                            <path
                                d="m7.73 27.208-1.601 0.242c0.187 0.133 0.375 0.266 0.562 0.398l0.52 0.36c0.348 0.242 0.719 0.453 1.117 0.64 0.563 0.293 1.137 0.547 1.723 0.762l0.238 0.078c0.266 0.078 0.535 0.16 0.801 0.239-0.586-0.559-1.055-1.094-1.399-1.598l-0.882-0.32c-0.399-0.215-0.758-0.481-1.079-0.801z"
                                fill="#9fde51" fill-rule="evenodd" />
                            <path
                                d="m2.008 22.809c1.574 1.278 3.297 2.399 5.16 3.36l0.043-0.36c0.184-0.32 0.57-0.453 1.16-0.402-0.613-2.051-0.894-4.211-0.84-6.48 0.078-3.383 0.946-6.692 2.598-9.918 1.547-2.989 3.586-5.082 6.121-6.282 1.785-0.824 3.719-1.172 5.801-1.039h0.039c-0.399-0.215-0.813-0.398-1.242-0.558l-5.278-1.082-3.679 0.402c-0.266 0.051-0.52 0.117-0.762 0.199l-0.121 0.039c-0.16 0.055-0.317 0.106-0.477 0.16-0.375 0.133-0.734 0.266-1.082 0.399l-2.918 1.562c-2 1.387-3.601 3.239-4.801 5.559-0.132 0.266-0.265 0.547-0.402 0.84-0.023 0.027-0.039 0.054-0.039 0.082l-1 3.16c-0.187 1.066-0.266 2.16-0.238 3.277 0.078 2.508 0.73 4.868 1.957 7.082z"
                                fill="#faef53" fill-rule="evenodd" />
                            <path
                                d="m2.008 22.809c1.066 1.84 2.441 3.387 4.121 4.641l1.601-0.242c-0.375-0.375-0.562-0.719-0.562-1.039-1.863-0.961-3.586-2.082-5.16-3.36z"
                                fill="#e9b41f" fill-rule="evenodd" />
                            <g clip-path="url(#j)">
                ...
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <div class="align-middle">
                        ...
                        <p class="text-gray-600 mb-8">
                            Dans un environnement naturel et festif vous pourrez profiter de toutes nos activités
                            récréatives.
                        </p>
                    </div>
                </div>
        ...
        <div class="container mx-auto px-8">
            <div class="w-full flex flex-col md:flex-row py-6">
                <div class="flex-1 mb-6 text-black">
                    <a class="text-black no-underline hover:no-underline font-bold text-2xl lg:text-4xl"
                        href="#">
                        MES VACANCES
                    </a>
                </div>
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#"
                                class="no-underline hover:underline text-gray-800 hover:text-pink-500">Données
                                légales</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#"
